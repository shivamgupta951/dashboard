...
const Collab = () => {
  return (
    <div className="min-h-[700px] bg-gradient-to-br from-[#4d2707db] via-black to-[#050219] flex justify-around items-center">
      <motion.div initial={{x:-150 , opacity:0}} animate={{x:0,opacity:1}} transition={{duration:3 , repeat: Infinity , repeatDelay:5}} className="border-dashed border-l-2 w-[30%] p-4">
        ...
        <div className="italic">
          ...
          built meaningful connections that continue to grow stronger every day.
        </div>
      </motion.div>
      <CollabBox />
    </div>
